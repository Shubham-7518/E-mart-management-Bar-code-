...
public class ViewAllEmployeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtAllEmployees = new javax.swing.JTable();
        ...
        jtAllEmployees.setFont(new java.awt.Font("sansserif", 1, 12)); // NOI18N
        jtAllEmployees.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jtAllEmployees);
    ...
    private javax.swing.JTable jtAllEmployees;
    ...
    private void loadAllData() {
        try{
            ...
            DefaultTableModel model = (DefaultTableModel)jtAllEmployees.getModel();
            for(EmployeePojo e:empList){
                empdata[0] = e.getEmpid();
                empdata[1] = e.getEmpname();
                empdata[2] = e.getEmpjob();
                empdata[3] = e.getEmpsal();
                model.addRow(empdata);
            } 
        }
        catch(SQLException sqlex){
                JOptionPane.showMessageDialog(null,"Can't load the employees!, DB error!","Error",JOptionPane.ERROR_MESSAGE);
        }
